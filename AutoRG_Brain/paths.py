...
base = os.environ.get('nnUNet_raw_data_base', '/data/cwang/mri_data/raw_data')
preprocessing_output_dir = os.environ.get('nnUNet_preprocessed', '/data/cwang/mri_data/preprocessed_files')
network_training_output_dir_base = os.environ.get('RESULTS_FOLDER', '/data/cwang/mri_data/nnUNet_trained_models')
