...
def main():
    ...
    parser.add_argument('-chk', help='checkpoint name, default: AutoRG_Brain_SEG', default='AutoRG_Brain_SEG')
    parser.add_argument('-test', "--test_file", required=False,default=None, help="folder of groudtruth segmentation")

    parser.add_argument("--save_output_nii", required=False, default=False, action="store_true")

    parser.add_argument("--modal", type=str, required=True, help="the input modality of the test image")

    parser.add_argument("--dice_type", type=str, required=True, default="anatomy")
    ...
    dice_type = args.dice_type ## anatomy or abnormal
    ...
    st = time()
    dice_abnormal = predict_from_folder(model_folder_name, output_folder, test_file, save_npz, num_threads_preprocessing,
                        num_threads_nifti_save, dice_type, part_id, num_parts, not disable_tta,
                        save_output_nii = args.save_output_nii, overwrite_all_in_gpu=all_in_gpu,
