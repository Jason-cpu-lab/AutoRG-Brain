...
def main():
    ...
    parser.add_argument("-train_batch", "--num_batches_per_epoch", type=int, required=False, default=1)
    parser.add_argument("-val_batch", "--num_val_batches_per_epoch", type=int, required=False, default=1)
