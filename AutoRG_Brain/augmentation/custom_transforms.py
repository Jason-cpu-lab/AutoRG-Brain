...
class MaskTransform(AbstractTransform):
    def __init__(self, dct_for_where_it_was_used, mask_idx_in_seg=1, set_outside_to=0, data_key="data", seg_key="seg"):
        ...
        :param seg_key:
        """
        self.dct_for_where_it_was_used = dct_for_where_it_was_used # OrderedDict([(0, False)])
        self.seg_key = seg_key
        self.data_key = data_key
        self.set_outside_to = set_outside_to # 0
        self.mask_idx_in_seg = mask_idx_in_seg # 0
    ...
    def __call__(self, **data_dict):
        ...
        for b in range(data.shape[0]):
            ...
            for c in range(data.shape[1]):
                ...
                if c in self.dct_for_where_it_was_used and self.dct_for_where_it_was_used[c]:
