    ...
    def save_checkpoint(self, fname, save_optimizer=True):
        ...
        save_this = {
            ...
            'plot_stuff': (self.all_tr_losses, self.all_val_losses, self.all_val_losses_tr_mode,
                           self.all_val_eval_metrics_ana, self.all_val_eval_metrics_ab, self.all_train_eval_metrics_ana, self.all_train_eval_metrics_ab,self.val_eval_criterion_MA),
            'best_stuff' : (self.best_epoch_based_on_MA_tr_loss, self.best_MA_tr_loss_for_patience, self.best_val_eval_criterion_MA_ana, self.best_val_eval_criterion_MA_ab, self.best_val_eval_criterion_MA)}
