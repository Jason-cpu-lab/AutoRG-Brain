...
from augmentation.default_data_augmentation import default_3D_augmentation_params, get_default_augmentation, get_patch_size
from loss.dice_loss import DC_and_CE_loss

from preprocess.preprocessing import GenericPreprocessor
# from nnunet.evaluation.evaluator import aggregate_scores
from utilities.segmentation_export import save_segmentation_nifti_from_softmax
...
class nnUNetTrainer(NetworkTrainer):
    ...
    def preprocess_patient(self, input_files, seg_file=None, target_shape=None):
        """
        ...
        preprocessor = GenericPreprocessor(self.normalization_schemes, self.use_mask_for_norm, self.transpose_forward, self.intensity_properties)

        d, s, properties = preprocessor.preprocess_test_case(input_files,
                                                             self.plans['plans_per_stage'][self.stage][
                                                                 'current_spacing'],seg_file,target_shape=target_shape)
    ...
    def save_checkpoint(self, fname, save_optimizer=True):
        ...
        # Save network state
        save_dict['network_weights'] = self.network.state_dict()

        # Save plans
        save_dict['plans'] = self.plans
